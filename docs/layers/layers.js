...
lyr_OpenStreetMap_0.setVisible(true);lyr_boeken_1.setVisible(true);lyr_pers_2.setVisible(true);lyr_kerkfotografie_3.setVisible(true);lyr_mijnstreek_4.setVisible(true);lyr_maas_en_waal_5.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_boeken_1,lyr_pers_2,lyr_kerkfotografie_3,lyr_mijnstreek_4,lyr_maas_en_waal_5];
...
lyr_maas_en_waal_5.on('precompose', function(evt) {
