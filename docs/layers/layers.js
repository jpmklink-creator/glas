...
lyr_OpenStreetMap_0.setVisible(true);lyr_webpaginas_1.setVisible(true);lyr_boeken_2.setVisible(true);lyr_pers_3.setVisible(true);lyr_kunstenaars_4.setVisible(true);lyr_kerkfotografie_5.setVisible(true);lyr_mijnstreek_6.setVisible(true);lyr_oostbrabant_7.setVisible(true);lyr_maas_en_waal_8.setVisible(true);lyr_beeldbankRCE_9.setVisible(true);lyr_limburg_10.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_webpaginas_1,lyr_boeken_2,lyr_pers_3,lyr_kunstenaars_4,lyr_kerkfotografie_5,lyr_mijnstreek_6,lyr_oostbrabant_7,lyr_maas_en_waal_8,lyr_beeldbankRCE_9,lyr_limburg_10];
